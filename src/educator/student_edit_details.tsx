...
class StudentEdit extends React.Component<any, any> {
  //const { classes } = props;
      ...
      <div>
          <Grid container spacing={24} className={classes.grid}>
              <Grid item xs={6} sm={6} md={6} lg={6}>
                ...
                <br/>
                <br/>
                is this the students gender of birth
              </Grid>
              <Grid item xs={6} sm={6} md={6} lg={6}>
                ethinicty
                <br/>
...
export default connect(mapStateToProps, mapDispatchToProps)(withStyles(styles)(withRouter(StudentEdit)));
