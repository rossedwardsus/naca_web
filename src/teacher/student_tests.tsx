...
class TeacherStudentTest extends React.Component<any, any> {
  //const { classes } = props;
...
export default connect(mapStateToProps, mapDispatchToProps)(withStyles(styles)(withRouter(TeacherStudentTest)));
