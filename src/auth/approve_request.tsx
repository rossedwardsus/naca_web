...
class ApproveRequest extends React.Component<any, any> {
  //const { classes } = props;
  ...
  render(){
    ...
    return (
      <div>
          Name School Email<Button>Approve</Button>
          <br/>
          <br/>
          Name School Email<Button>Approve</Button>
          <br/>
...
export default connect(mapStateToProps, mapDispatchToProps)(withStyles(styles)(withRouter(ApproveRequest)));
