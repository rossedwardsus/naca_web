...
const defaultState: any = {
    ...
    students: [{student_id: "1", teacher_id: "1", student_first_name: "first name", student_last_name: "last name", naca_results: [{date_taken: "", answers: {question_id: 1, answer: "1"}}], attendance: {class_id: 1, days: ""}, students_groups: []}]
};
