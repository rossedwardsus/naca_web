...
export default function quizAnswerReducer(state: any = defaultState, action: any): any {
  ...
  switch (action.type) {
     ...
     //let search_terms = action.note_text.split(" ");
  	 ...
  	 temp_state = state.student_quiz_answers;
  	 temp_state.push(action.payload.answer);
