...
const defaultState: any = {
    ...
    quizes: [{quiz_id: 1, quiz_question: "I live in the same house as:", quiz_choices: [{text: "Real mom and Real dad", value: "real"}, {text: "\"Real mom\" and 'real dad', but not TOGETHER (separated or divorced)", value: "real_not_together"}]}]
};
